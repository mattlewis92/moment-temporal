...
function getDateOffset(m) {
    // Offsets can be sub-minute in the LMT era; moment rounds them the way
    // Date#getTimezoneOffset consumers did (see moment/moment#1871).
    return -Math.round(-fieldsAt(m._d.valueOf(), systemZoneId()).offset);
}
