//! moment-timezone.js — reimplemented for moment-temporal
//! API-compatible with moment-timezone 0.6.3 (MIT), github.com/moment/moment-timezone
//! Ships no timezone data: zones resolve through the host's IANA database via
//! the Temporal API (see ./temporal-zone.js). Packed-data loading (tz.add /
...
// Live links so the Temporal-backed zones observe flag mutations and loaded
// country data.
TemporalZone._flags = tz;
TemporalZone._countries = countries;
